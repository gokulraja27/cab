...
class DistancesControllerTest < ActionController::TestCase
  ...
  test "should create distance" do
    assert_difference('Distance.count') do
      post :create, distance: { end_place_id: @distance.end_place_id, kilometer: @distance.kilometer, start_place_id: @distance.start_place_id }
    end
  ...
  test "should update distance" do
    patch :update, id: @distance, distance: { end_place_id: @distance.end_place_id, kilometer: @distance.kilometer, start_place_id: @distance.start_place_id }
    assert_redirected_to distance_path(assigns(:distance))
  end
